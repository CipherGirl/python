"""
Docstring for module_3.gc_module
...
startup
 ...
 │
 ├─ main(change_gc)
 │   ├─ optionally modify GC thresholds
 │   ├─ create MANY objects
...
# gc.set_debug(gc.DEBUG_STATS) - For logging the gc
# gc.freeze() - Moves currently alive objects into a permanent generation
